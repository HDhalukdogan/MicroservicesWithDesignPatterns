            ...
            Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    services.AddMassTransit(cfg =>
                    {
                        ...
                        {
                            //configure.Host(hostContext.Configuration.GetConnectionString("RabbitMQLocal"));
                            configure.Host(hostContext.Configuration.GetConnectionString("RabbitMQLocal"), "/", host =>
                            {
                                host.Username("guest");
                                host.Password("guest");
                            });
